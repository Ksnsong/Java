...
//                }
     ...
     * @return  A Vector of ElephantsAndRhinos consisting of all moves the Left player can legally make.
     */
    public Vector<ElephantsAndRhinos> getLeftPositions() {
        Vector<ElephantsAndRhinos> positions = new Vector<ElephantsAndRhinos>();
...
//                }
     ...
     * @return  A Vector of ElephantsAndRhinos consisting of all moves the Right player can legally make.
     */
    public Vector<ElephantsAndRhinos> getRightPositions() {
        Vector<ElephantsAndRhinos> positions = new Vector<ElephantsAndRhinos>();
        ArrayList<Integer> positionBoxes;  //need another variable to prevent aliasing
