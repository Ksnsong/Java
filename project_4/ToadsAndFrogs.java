...
public class ToadsAndFrogs {
     ...
     * @return  An ArrayList of ToadsAndFrogs consisting of all moves the Left player can legally make.
     */
    public ArrayList<ToadsAndFrogs> getLeftPositions() {
    	ArrayList<ToadsAndFrogs> positions = new ArrayList<ToadsAndFrogs>();
...
//                }
     ...
     * @return  An ArrayList of ToadsAndFrogs consisting of all moves the Right player can legally make.
     */
    public ArrayList<ToadsAndFrogs> getRightPositions() {
    	ArrayList<ToadsAndFrogs> positions = new ArrayList<ToadsAndFrogs>();
        ArrayList<Integer> positionBoxes;  //need another variable to prevent aliasing
